...
clckwrksOpts def =
    ...
    , Option [] ["rebac-schema-path"] (ReqArg setRebacSchemaPath "path") ("path to REBAC schema, default: " ++ show (clckRebacSchemaPath def))
    ...
    where
      ...
      setRebacSchemaPath str = ModifyConfig $ \c -> c { clckRebacSchemaPath = Just str }
